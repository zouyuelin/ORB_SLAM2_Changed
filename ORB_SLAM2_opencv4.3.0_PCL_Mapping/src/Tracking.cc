...
Tracking::Tracking(System *pSys, ORBVocabulary* pVoc, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer, Map *pMap, shared_ptr<PointCloudMapping> pPointCloud, KeyFrameDatabase* pKFDB, const string &strSettingPath, const int sensor):
    ...
    mpPointCloudMapping( pPointCloud ),mkeyPointsThreshold(100),
...
void Tracking::MonocularInitialization()
{
    ...
    {
        // Set Reference Frame
        if(mCurrentFrame.mvKeys.size()>mkeyPointsThreshold)
        {
            ...
            cout << "the first frame has been created and initialized\n";
    ...
    {
        // Try to initialize
        if((int)mCurrentFrame.mvKeys.size()<=mkeyPointsThreshold)
        {
            delete mpInitializer;
        ...
        int nmatches = matcher.SearchForInitialization(mInitialFrame,mCurrentFrame,mvbPrevMatched,mvIniMatches,mkeyPointsThreshold);

        // Check if there are enough correspondences
        if(nmatches<mkeyPointsThreshold)
        {
            delete mpInitializer;
            mpInitializer = static_cast<Initializer*>(NULL);
            return;
...
void Tracking::CreateInitialMapMonocular()
{
    ...
    if(medianDepth<0 || pKFcur->TrackedMapPoints(1)<mkeyPointsThreshold)
    {
